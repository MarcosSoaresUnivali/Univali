...
int main() {
    ...
    if ((out_file = fopen("..\\saida_lms_M3.pcm", "wb")) == NULL){ // Sinal de saida
        printf("\nErro: Nao abriu o arquivo de saida\n");
        return 0;
    }
    if ((out_d_file = fopen("..\\saida_lms_d_M3.pcm", "wb")) == NULL){ // Sinal de saida d
        printf("\nErro: Nao abriu o arquivo de saida\n");
        return 0;
    }
    if ((out_e_file = fopen("..\\saida_lms_e_M3.pcm", "wb")) == NULL){ // Sinal de erro
        printf("\nErro: Nao abriu o arquivo de erro\n");
        return 0;
    }
    if ((out_erro = fopen("..\\error_M3.dat", "wb")) == NULL){ // Erro
        printf("\nErro: Nao abriu o arquivo de saida\n");
        return 0;
    }
